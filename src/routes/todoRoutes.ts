...
import { createTodos, listTodos, updateTodos, deleteTodos, dailyCompletedTaskCount } from '../controllers/todo.controller'
...
server.get('/completed/daily-stats', auth, dailyCompletedTaskCount)
